...
export function TutorialSection({
  ...
  showContinueButton,
  onContinue,
  continueButtonText = '先を読む',
}: TutorialSectionProps) {
  return (
    <div className="tutorial-section">
      <div className="tutorial-section__content">{children}</div>

      {showContinueButton && (
        <div className="tutorial-section__footer">
          <button className="tutorial-section__continue-btn" onClick={onContinue}>
            <span className="btn-text">{continueButtonText}</span>
