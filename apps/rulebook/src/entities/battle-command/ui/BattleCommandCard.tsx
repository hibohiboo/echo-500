...
interface BattleCommandCardProps {
  name: string;
  cp: number;
  timing: string;
  target: string;
  ...
  return (
    <div class="battle-command-card" onClick={props.onClick}>
      <div class="battle-command-card__border">
        ...
        <div class="battle-command-card__grid">
          <div class="battle-command-card__field">
            <span class="battle-command-card__label">タイミング</span>
            <span class="battle-command-card__value">{props.timing}</span>
          </div>
          <div class="battle-command-card__field">
            <span class="battle-command-card__label">対象</span>
            <span class="battle-command-card__value">{props.target}</span>
          </div>
          <div class="battle-command-card__field">
            <span class="battle-command-card__label">射程</span>
            <span class="battle-command-card__value">{props.range}</span>
          </div>
          <div class="battle-command-card__field">
            <span class="battle-command-card__label">コスト</span>
            <span class="battle-command-card__value">{props.cost}</span>
          </div>
        </div>

        <div class="battle-command-card__effect">
          <span class="battle-command-card__label">効果</span>
          <p class="battle-command-card__effect-text">{props.effect}</p>
        </div>

        <Show when={props.flavor}>
          <div class="battle-command-card__flavor">
            <p class="battle-command-card__flavor-text">"{props.flavor}"</p>
          </div>
        </Show>

        <Show when={props.tags.length > 0}>
          <div class="battle-command-card__tags">
            <For each={props.tags}>
              {(tag) => <span class="battle-command-card__tag">{tag}</span>}
            </For>
          </div>
        </Show>
        ...
        <Show when={props.details}>
          <button
            class="battle-command-card__toggle"
          ...
          <Show when={isExpanded()}>
            <div class="battle-command-card__details">
              <span class="battle-command-card__label">詳細</span>
              <p class="battle-command-card__details-text">{props.details}</p>
            </div>
          </Show>
        </Show>

        <div class="battle-command-card__circuit">
